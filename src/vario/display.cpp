...
// Leaf Hardware V3.2.2+
  U8G2_ST75256_JLX19296_F_4W_HW_SPI u8g2(U8G2_R1, /* cs=*/ SPI_SS_LCD, /* dc=*/ LCD_RS, /* reset=*/ LCD_RESET); 
...
void display_setContrast(uint8_t contrast) {
  u8g2.setContrast(contrast+115);             // user can select levels of contrast from 0-20; but display needs values of 115-135.
}
